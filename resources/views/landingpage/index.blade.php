...
<!-- Mirrored from www.ansonika.com/foogra/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Feb 2023 06:30:48 GMT -->
            ...
            <nav class="main-menu">
                ...
                <ul>
                        ...
                        <ul>
                            <li class="third-level"><a href="#0">List pages</a>
                                <ul>
                                    ...
                                    <li><a href="grid-listing-filterscol-full-masonry.html">List Masonry Filter</a>
                                    </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                            <li><a href="html_rtl/index.html">RLT Version <strong>New!</strong></a></li>
                    ...
                    <li><a href="https://1.envato.market/dA652" target="_parent">Buy this template</a></li>
                </ul>
            </nav>
        </div>
    </header>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-9 col-lg-10 col-md-8">
                            ...
                            <form method="post" action="http://www.ansonika.com/foogra/grid-listing-filterscol.html">
            ...
            <div class="container clearfix">
                <div class="col-lg-5 col-md-6 float-end wow">
                    <div class="box_1">
                        ...
                        <a href="submit-restaurant.html" class="btn_1">Submit</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="collapse dont-collapse-sm" id="collapse_4">
                        <div id="newsletter">
                            ...
                            <form method="post" action="http://www.ansonika.com/foogra/assets/newsletter.php"
